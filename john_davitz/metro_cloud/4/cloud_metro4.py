...
limit = 1000000
max_rows = int((110696370/4)*4) # For testing; use full count later
nyc_token = "SW2XSork4jhlso8u65TTPju2z"
...
offsets = list(range(int((110696370/4)*3), max_rows, limit))
batch_size = 5
max_workers = 10
intermediate_dfs = []
...
final_csv_path = "/tmp/metro_api_output4.csv"
...
blob = bucket.blob("output/metro_api_output4.csv")
