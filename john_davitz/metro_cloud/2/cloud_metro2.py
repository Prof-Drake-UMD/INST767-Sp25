...
limit = 500000
max_rows = int((110696370/8)*2) # For testing; use full count later
...
offsets = list(range(int(110696370/8), max_rows, limit))
batch_size = 5
max_workers = 10
intermediate_dfs = []
...
final_csv_path = "/tmp/metro_api_output2.csv"
...
blob = bucket.blob("output/metro_api_output2.csv")
