...
class ExtractRecallEnforcementChunk():
    """
    Description:
    ...
    def fetch_recall_enforcement_chunk(self, url, api_key, record_limit) -> dict:
        """
        Description:
...
# recallEnforcement = ExtractRecallEnformentChunk(0)

# recall_enforcementdata = recallEnforcement.fetch_recall_enforcement_chunk('https://api.fda.gov/drug/enforcement.json', 'NebaLf3RBFwixQatBtfqnCcCa7M7apfggKciPMBO' , 1)

# print(recall_enforcementdata)
