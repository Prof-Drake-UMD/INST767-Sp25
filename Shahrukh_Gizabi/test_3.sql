CREATE TABLE soccer_premier_league_analytics.TeamSeasonStats_CleanTest (
    ...
    goals STRUCT<
        `for` STRUCT<
            ...
            >,
            -- Let's test with ONLY ONE under_over field first
            under_over_stats STRUCT<  -- Changed name slightly for this test field
                uo_0_5 STRUCT<over_val INT64, under_val INT64>  -- Simplified field names within
            >
        >,
        against STRUCT< 
            total STRUCT<home INT64, away INT64, total INT64>,
            average STRUCT<home STRING, away STRING, total STRING>,
            minute STRUCT< -- Simplified for this test
                min_0_15 STRUCT<total INT64, percentage STRING>
            >,
            under_over_stats STRUCT< -- Simplified for this test
                 uo_0_5 STRUCT<over_val INT64, under_val INT64>
            >
        >
    >,
    biggest STRUCT<
    ...
    >,
    cards STRUCT<
        yellow STRUCT< -- Simplified for this test
            min_0_15 STRUCT<total INT64, percentage STRING>
        >,
        red STRUCT< -- Simplified for this test
            min_0_15 STRUCT<total INT64, percentage STRING>
        >
    >,
