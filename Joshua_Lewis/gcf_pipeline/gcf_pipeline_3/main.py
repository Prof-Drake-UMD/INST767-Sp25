...
def run_pipeline(request):
    """
    Cloud Function entry point that processes disaster data and uploads to GCS.
    Args:
    ...
    try:
        ...
        # Only attempt GCS upload if not in local testing
        if os.getenv('FUNCTION_TARGET'):  # This env var exists in Cloud Functions
            ...
            print("⚠️ Skipping GCS upload during local testing")
